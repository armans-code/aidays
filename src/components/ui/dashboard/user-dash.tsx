    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-sky-100 to-sky-50">
      <header className="bg-primary text-primary-foreground p-6 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <Button variant="outline" className="text-black border-primary-foreground hover:bg-primary-foreground hover:text-primary">
            Logout
          </Button>
        </div>
      </header>
      ...
      <main className="flex-grow container mx-auto p-8">
        <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Dashboard</h2>
        <div className="grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
          <Card className="bg-white/50 backdrop-blur-sm hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>View resource distribution and heatmap</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <CardContent>
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-start">
                ...
                <span>Use the Aid Link Map to view current resource requests from other users, power statuses, and areas of high severity.</span>
              </li>
              <li className="flex items-start">
                <FileText className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" />
                <span>Submit a new request if you need resources or assistance in your area.</span>
              </li>
              <li className="flex items-start">
                <MessageCircle className="w-5 h-5 mr-2 text-purple-500 flex-shrink-0 mt-0.5" />
                <span>Use the chat feature for immediate support or questions about the platform.</span>
              </li>
            </ul>
          </CardContent>
        </Card>
